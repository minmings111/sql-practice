...
| `LEFT JOIN`과 `COALESCE` | [28](./28_teams_match_points_ranking.sql), [29](./29_players_game_points_ranking.sql) |
| `UNION ALL` | [28](./28_teams_match_points_ranking.sql), [29](./29_players_game_points_ranking.sql) |
