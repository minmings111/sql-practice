...
| `LEFT JOIN`과 `COALESCE` | [28](./28_teams_match_points_ranking.sql), [29](./29_players_game_points_ranking.sql), [30](./30_employees_review_scores_ranking.sql) |
...
| 윈도우 함수 | [19](./19_events_latest_value_difference.sql), [31](./31_price_logs_latest_price_change.sql), [32](./32_sensor_readings_latest_delta.sql) |
